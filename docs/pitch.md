...
- The cost numbers are estimated from token counts × public rates, not from Anthropic invoices. Close enough to be directionally right, not a replacement for billing.
